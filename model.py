...
class UniformAttentionSublayer(nn.Module):
    def __init__(self, dimension, heads, max_pos_len, attention_dropout):
        ...
        self.input_transform = nn.Linear(dimension, 3*dimension, bias=False)
    ...
    def forward(self, input, mask):
        ...
        indices = self.attention_dropout(indices)
...
class EncoderLayer(nn.Module):
    def __init__(self, dimension, heads, dropout, max_pos_len, attention_dropout):
        ...
        self.attention = UniformAttentionSublayer(dimension, heads, max_pos_len, attention_dropout)
...
class DecoderLayer(nn.Module):
    def __init__(self, dimension, heads, dropout, max_pos_len, attention_dropout):
        ...
        self.attention_1 = UniformAttentionSublayer(dimension, heads, max_pos_len, attention_dropout)
        self.dropout_1 = nn.Dropout(dropout)
        self.layer_norm_1 = nn.LayerNorm(dimension)

        self.attention_2 = DividedAttentionSublayer(dimension, heads, max_pos_len, attention_dropout)
        self.dropout_2 = nn.Dropout(dropout)
        self.layer_norm_2 = nn.LayerNorm(dimension)

        self.attention_3 = DividedAttentionSublayer(dimension, heads, max_pos_len, attention_dropout)
